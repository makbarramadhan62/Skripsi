...
with open('../CSV/cropped_manual/5_Label/RGB_GLCM/RGB_GLCM[all]1_Training.csv', 'w', newline='') as csvfile:
...
# membuka file CSV untuk menyimpan hasil ekstraksi fitur
with open('../CSV/cropped_manual/5_Label/RGB_GLCM/RGB_GLCM[all]1_Testing.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerow(
        ['label', 'R', 'G', 'B'] + [f'{prop} {angle}' for prop in glcm_properties_1 for angle in angles])
...
# membuka file CSV untuk menyimpan hasil ekstraksi fitur
with open('../CSV/cropped_manual/5_Label/RGB_GLCM/RGB_GLCM[all]2_Training.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerow(
...
# membuka file CSV untuk menyimpan hasil ekstraksi fitur
with open('../CSV/cropped_manual/5_Label/RGB_GLCM/RGB_GLCM[all]2_Testing.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerow(
        ['label', 'R', 'G', 'B'] + [f'{prop} {angle}' for prop in glcm_properties_2 for angle in angles])
...
# membuka file CSV untuk menyimpan hasil ekstraksi fitur
with open('../CSV/cropped_manual/5_Label/RGB_GLCM/RGB_GLCM[all]3_Training.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerow(
...
# membuka file CSV untuk menyimpan hasil ekstraksi fitur
with open('../CSV/cropped_manual/5_Label/RGB_GLCM/RGB_GLCM[all]3_Testing.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerow(
        ['label', 'R', 'G', 'B'] + [f'{prop} {angle}' for prop in glcm_properties_3 for angle in angles])
...
# membuka file CSV untuk menyimpan hasil ekstraksi fitur
with open('../CSV/cropped_manual/5_Label/RGB_GLCM/RGB_GLCM[all]4_Training.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerow(
...
# membuka file CSV untuk menyimpan hasil ekstraksi fitur
with open('../CSV/cropped_manual/5_Label/RGB_GLCM/RGB_GLCM[all]4_Testing.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerow(
        ['label', 'R', 'G', 'B'] + [f'{prop} {angle}' for prop in glcm_properties_4 for angle in angles])
