...
with open('../CSV/cropped_manual/5_label/HSV_GLCM/HSV_GLCM[all]1_Training.csv', 'w', newline='') as csvfile:
...
# membuka file CSV untuk menyimpan hasil ekstraksi fitur
with open('../CSV/cropped_manual/5_label/HSV_GLCM/HSV_GLCM[all]1_Testing.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerow(
        ['label', 'H', 'S', 'V'] + [f'{prop} {angle}' for prop in glcm_properties_1 for angle in angles])
...
# membuka file CSV untuk menyimpan hasil ekstraksi fitur
with open('../CSV/cropped_manual/5_label/HSV_GLCM/HSV_GLCM[all]2_Training.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerow(
    ...
    for root, dirs, files in os.walk('../Dataset/Raw/5_label/DataSet_Training'):
        ...
        for image_file in image_files:
            ...
            row = [(c-1), mean_h, mean_s, mean_v] + feature[:]
            writer.writerow(row)
...
# membuka file CSV untuk menyimpan hasil ekstraksi fitur
with open('../CSV/cropped_manual/5_label/HSV_GLCM/HSV_GLCM[all]2_Testing.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerow(
        ['label', 'H', 'S', 'V'] + [f'{prop} {angle}' for prop in glcm_properties_2 for angle in angles])
    ...
    for root, dirs, files in os.walk('../Dataset/Raw/5_label/DataSet_Testing'):
        ...
        for image_file in image_files:
            ...
            row = [(d-1), mean_h, mean_s, mean_v] + feature[:]
            writer.writerow(row)
...
# membuka file CSV untuk menyimpan hasil ekstraksi fitur
with open('../CSV/cropped_manual/5_label/HSV_GLCM/HSV_GLCM[all]3_Training.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerow(
    ...
    for root, dirs, files in os.walk('../Dataset/Raw/5_label/DataSet_Training'):
        ...
        for image_file in image_files:
            ...
            row = [(e-1), mean_h, mean_s, mean_v] + feature[:]
            writer.writerow(row)
...
# membuka file CSV untuk menyimpan hasil ekstraksi fitur
with open('../CSV/cropped_manual/5_label/HSV_GLCM/HSV_GLCM[all]3_Testing.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerow(
        ['label', 'H', 'S', 'V'] + [f'{prop} {angle}' for prop in glcm_properties_3 for angle in angles])
    ...
    for root, dirs, files in os.walk('../Dataset/Raw/5_label/DataSet_Testing'):
        ...
        for image_file in image_files:
            ...
            row = [(f-1), mean_h, mean_s, mean_v] + feature[:]
            writer.writerow(row)
...
# membuka file CSV untuk menyimpan hasil ekstraksi fitur
with open('../CSV/cropped_manual/5_label/HSV_GLCM/HSV_GLCM[all]4_Training.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerow(
    ...
    for root, dirs, files in os.walk('../Dataset/Raw/5_label/DataSet_Training'):
        ...
        for image_file in image_files:
            ...
            row = [(g-1), mean_h, mean_s, mean_v] + feature[:]
            writer.writerow(row)
...
# membuka file CSV untuk menyimpan hasil ekstraksi fitur
with open('../CSV/cropped_manual/5_label/HSV_GLCM/HSV_GLCM[all]4_Testing.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerow(
        ['label', 'H', 'S', 'V'] + [f'{prop} {angle}' for prop in glcm_properties_4 for angle in angles])
    ...
    for root, dirs, files in os.walk('../Dataset/Raw/5_label/DataSet_Testing'):
        ...
        for image_file in image_files:
            ...
            row = [(h-1), mean_h, mean_s, mean_v] + feature[:]
            writer.writerow(row)
