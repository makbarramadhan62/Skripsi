...
# membuka file CSV untuk menyimpan hasil ekstraksi fitur
with open('../../Code/csv/hasil_ekstraksi_orde1_glcm_Testing.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
    # writer.writerow(
    ...
    # melakukan ekstraksi fitur pada setiap folder
    for root, dirs, files in os.walk('../../Code/Dataset/DataSet_Testing'):
